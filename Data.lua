...
d.Name = "Header"
d.AnchorPoint = Vector2.new(0.5, 0.009999999776482582)
d.Size = UDim2.new(0.965999960899353, 0, 0.04770992323756218, 0)
d.Position = UDim2.new(0.5, 0, 0.023000000044703484, 0)
...
i.Size = UDim2.new(0.8500000238418579, 0, 0.9599999785423279, 0)
...
i.Text = "F3X Creations Collection"
i.TextWrap = true
...
na.Name = "Header"
na.ZIndex = 3
na.AnchorPoint = Vector2.new(0.5, 0.009999999776482582)
na.Size = UDim2.new(0.9660000205039978, 0, 0, 25)
na.Position = UDim2.new(0.5, 0, 0.009999999776482582, 0)
...
ya.Name = "Header"
ya.ZIndex = 4
ya.AnchorPoint = Vector2.new(0.5, 0.009999999776482582)
ya.Size = UDim2.new(0.9660000205039978, 0, 0, 25)
ya.Position = UDim2.new(0.5, 0, 0.023000000044703484, 0)
...
pb.Name = "NameBox"
pb.ZIndex = 3
pb.AnchorPoint = Vector2.new(0, 0.5)
pb.Size = UDim2.new(1.429093599319458, 0, 0.800000011920929, 0)
pb.BackgroundTransparency = 0.5
pb.Position = UDim2.new(0.8210875988006592, 0, 0.4999995231628418, 0)
pb.BackgroundColor3 = Color3.new(0.2980392277240753, 0.2980392277240753, 0.2980392277240753)
pb.CursorPosition = -1
pb.TextStrokeTransparency = 0.5
pb.PlaceholderColor3 = Color3.new(0.8078432083129883, 0.8078432083129883, 0.8078432083129883)
pb.FontSize = Enum.FontSize.Size14
pb.TextSize = 14
pb.TextWrapped = true
pb.TextWrap = true
...
pb.TextEditable = false
pb.Font = Enum.Font.SourceSans
pb.PlaceholderText = "?"
pb.TextScaled = true
pb.Parent=ob
local qb = Instance.new("UICorner")
qb.CornerRadius = UDim.new(0, 3)
qb.Parent=pb
local rb = Instance.new("TextLabel")
rb.Name = "CreationName"
rb.ZIndex = 3
rb.Size = UDim2.new(0.20485126972198486, 0, 0.09400000423192978, 0)
rb.BackgroundTransparency = 1
rb.Position = UDim2.new(0.04514876380562782, 0, 0.12960828840732574, 0)
rb.BackgroundColor3 = Color3.new(1, 1, 1)
rb.FontSize = Enum.FontSize.Size14
rb.TextStrokeTransparency = 0
rb.TextSize = 14
...
sb.Name = "Rename"
sb.ZIndex = 3
sb.AnchorPoint = Vector2.new(0, 1)
sb.Size = UDim2.new(0.2676258683204651, 0, 0.970274806022644, 0)
sb.BackgroundTransparency = 1
sb.Position = UDim2.new(3.9201364517211914, 0, 0.9826371669769287, 0)
sb.BackgroundColor3 = Color3.new(1, 1, 1)
sb.ScaleType = Enum.ScaleType.Fit
sb.Image = "http://www.roblox.com/asset/?id=10231271040"
sb.Parent=rb
local tb = Instance.new("TextBox")
tb.Name = "NameBox"
tb.ZIndex = 3
tb.AnchorPoint = Vector2.new(0, 0.5)
tb.Size = UDim2.new(3.0068554878234863, 0, 0.800000011920929, 0)
tb.BackgroundTransparency = 0.5
tb.Position = UDim2.new(0.7481168508529663, 0, 0.5, 0)
tb.BackgroundColor3 = Color3.new(0.2980392277240753, 0.2980392277240753, 0.2980392277240753)
tb.CursorPosition = -1
tb.TextStrokeTransparency = 0.5
tb.PlaceholderColor3 = Color3.new(0.8078432083129883, 0.8078432083129883, 0.8078432083129883)
tb.FontSize = Enum.FontSize.Size14
tb.TextSize = 14
tb.TextWrapped = true
tb.TextWrap = true
...
tb.TextScaled = true
tb.Parent=rb
local ub = Instance.new("UICorner")
ub.CornerRadius = UDim.new(0, 3)
ub.Parent=tb
local vb = Instance.new("TextButton")
vb.Name = "Fix"
vb.ZIndex = 3
vb.Size = UDim2.new(0.34506553411483765, 0, 0.07200460880994797, 0)
vb.BackgroundTransparency = 0.75
vb.Position = UDim2.new(0.33216601610183716, 0, 0.7248464226722717, 0)
vb.BackgroundColor3 = Color3.new(0.2980392277240753, 0.2980392277240753, 0.2980392277240753)
vb.AutoButtonColor = false
vb.FontSize = Enum.FontSize.Size14
vb.TextTransparency = 0.5
vb.TextStrokeTransparency = 0
vb.TextSize = 14
vb.TextColor3 = Color3.new(1, 1, 1)
vb.Text = "Fix creation"
vb.TextWrap = true
vb.Font = Enum.Font.SourceSans
vb.TextWrapped = true
vb.TextScaled = true
vb.Parent=gb
local wb = Instance.new("UICorner")
wb.CornerRadius = UDim.new(0, 3)
wb.Parent=vb
local xb = Instance.new("Folder")
xb.Parent=gb
local yb = Instance.new("ImageLabel")
yb.Name = "border"
yb.ZIndex = 0
yb.Size = UDim2.new(1, 0, 1, 0)
yb.BackgroundTransparency = 1
yb.BackgroundColor3 = Color3.new(0.6392160058021545, 0.6352940201759338, 0.6470590233802795)
yb.ScaleType = Enum.ScaleType.Slice
yb.ImageTransparency = 0.5
yb.ImageColor3 = Color3.new(0.20392157137393951, 0.20392157137393951, 0.20392157137393951)
yb.Image = "rbxasset://textures/AvatarImporter/button_avatarType_border.png"
yb.SliceCenter = Rect.new(4, 4, 5, 5)
yb.Parent=xb
local zb = Instance.new("UIGradient")
zb.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0, 0.0765027403831482); NumberSequenceKeypoint.new(0.5030674934387207, 0.08743172883987427); NumberSequenceKeypoint.new(1, 0.15846997499465942)})
zb.Rotation = -56
zb.Color = ColorSequence.new(Color3.new(0.07058823853731155, 0.07450980693101883, 0.08627451211214066), Color3.new(0.32548999786376953, 0.32548999786376953, 0.32548999786376953))
zb.Parent=gb
local Ab = Instance.new("UICorner")
Ab.CornerRadius = UDim.new(0, 7)
Ab.Parent=gb
local Bb = Instance.new("Frame")
Bb.Name = "Header"
Bb.ZIndex = 4
Bb.AnchorPoint = Vector2.new(0.5, 0.009999999776482582)
Bb.Size = UDim2.new(0.9660000205039978, 0, 0, 25)
Bb.Position = UDim2.new(0.5, 0, 0.023000000044703484, 0)
Bb.BackgroundColor3 = Color3.new(0.2666666805744171, 0.2666666805744171, 0.2666666805744171)
Bb.Parent=db
local Cb = Instance.new("TextButton")
Cb.Name = "Title"
Cb.ZIndex = 4
Cb.AnchorPoint = Vector2.new(0.5, 0.550000011920929)
Cb.Size = UDim2.new(0.850000262260437, 0, 0.8000000715255737, 0)
Cb.BackgroundTransparency = 1
Cb.Position = UDim2.new(0.5, 0, 0.527999997138977, 0)
Cb.BackgroundColor3 = Color3.new(1, 1, 1)
Cb.FontSize = Enum.FontSize.Size14
Cb.TextSize = 14
Cb.TextColor3 = Color3.new(1, 1, 1)
Cb.Text = "Creation information (nwz0)"
Cb.TextWrap = true
...
Db.Position = UDim2.new(0.8500000238418579, 0, 0.8539999723434448, 0)
...
Eb.Position = UDim2.new(1, 0, 0.8820000290870667, 0)
Eb.BackgroundColor3 = Color3.new(1, 1, 1)
Eb.FontSize = Enum.FontSize.Size24
Eb.TextSize = 20
Eb.TextColor3 = Color3.new(1, 0, 0)
Eb.Text = "x"
Eb.TextWrap = true
...
Fb.CornerRadius = UDim.new(0, 4)
Fb.Parent=Bb
local Gb = Instance.new("Folder")
Gb.Parent=Bb
local Hb = Instance.new("ImageLabel")
Hb.Name = "border"
Hb.ZIndex = 4
Hb.Size = UDim2.new(1, 0, 1, 0)
Hb.BackgroundTransparency = 1
Hb.BackgroundColor3 = Color3.new(0.6392160058021545, 0.6352940201759338, 0.6470590233802795)
Hb.ScaleType = Enum.ScaleType.Slice
Hb.ImageTransparency = 0.5
Hb.ImageColor3 = Color3.new(0.20392157137393951, 0.20392157137393951, 0.20392157137393951)
Hb.Image = "rbxasset://textures/AvatarImporter/button_avatarType_border.png"
Hb.SliceCenter = Rect.new(4, 4, 5, 5)
Hb.Parent=Gb
...
function getAPI()
	if not _G.apiJson then print"Loading API Dump" end
